# Matthew Graham's dotfiles for Windows (forked from Jay Harris's dotfiles)
...
From PowerShell:
```posh
git clone https://github.com/jonbons/dotfiles-windows.git; cd dotfiles-windows; . .\bootstrap.ps1
```
...
```bash
iex ((new-object net.webclient).DownloadString('https://raw.github.com/jonbons/dotfiles-windows/master/setup/install.ps1'))
```
...
Set-Environment "EMAIL" "Matthew Graham <me@mattgraham.me>"

# Git credentials
# Not in the repository, to prevent people from accidentally committing under my name
Set-Environment "GIT_AUTHOR_NAME" "Matthew Graham","User"
Set-Environment "GIT_COMMITTER_NAME" $env:GIT_AUTHOR_NAME
git config --global user.name $env:GIT_AUTHOR_NAME
Set-Environment "GIT_AUTHOR_EMAIL" "me@mattgraham.me"
